...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-ym-%+s#m^j16b8c7!r(kfq6de^@xg4%7klk^dii$(g&k1o069h')
...
CACHE_TTL = int(os.getenv('CACHE_TTL', 60 * 15))  # 15 minutes default
